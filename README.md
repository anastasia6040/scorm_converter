...
![Страница авторизации](screenshots/Авторизация.png)

### Загрузка документа

![Главная страница](screenshots/Загрузка документа.png)

### Заполнение метаданных

![Описание курса](screenshots/Заполнение метаданных.png)

### Прогресс конветрации

![Прогресс](screenshots/Прогресс.png)

### Предпросмотр курса

![Предпросмотр курса](screenshots/Предпросмотр.png)

### Встроенный редактор курса

![Редактор](screenshots/Редактор.png)

### История конвертаций

![Страница Мои курсы](screenshots/История.png)
